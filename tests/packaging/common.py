...
WIN_AGENT_LATEST_URL = "https://dl.signalfx.com/windows/{stage}/{format}/latest/latest.txt"
...
def get_latest_win_agent_version(stage="release", format="msi"):
    return requests.get(WIN_AGENT_LATEST_URL.format(stage=stage, format=format)).text.strip()
